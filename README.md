...
| [Because-you-asked-about-the-line-between-headful-and-headless](Because-you-asked-about-the-line-between-headful-and-headless) | **Live view vs. CDP screencast, side by side.** Watch both in one page. The screencast streams straight from the browser tab with no relay server, and forwards mouse and keyboard back over CDP `Input.*`. |
